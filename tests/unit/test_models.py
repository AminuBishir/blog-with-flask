...
from blog_with_flask.models.dbhelper import Blog, Comment, User


#fixture for new user
@fixture(scope='module')
def new_blog(user_name, create_date, post_id):
	user = Blog(subject='blog-name',content='this is a test blog post',
	author=user_name, created=create_date, img_src='', p_id=post_id)
	return user
...
def test_comment(post_id, user_name):
	...
	assert comment.serialize == {'Created':None, 'id':1, 'p_id':post_id, 'commentor':user_name, 'comment':"Hello there is this is a new comment"}
